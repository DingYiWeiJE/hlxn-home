...
async function HeaderSection({ locale }: { locale: string }) {
  ...
  return (
    <PageHero
      location="ABOUT_US"
      fallbackImage="/images/about/about-background.jpeg"
      title={t("aboutPage.header")}
      subtitle={t("aboutPage.headerSubtitle")}
      overlayClassName="bg-[#001524C9] opacity-50"
      titleClassName="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4"
      subtitleClassName="text-lg md:text-xl text-white max-w-2xl"
    />
  );
}
